...
class FileHandler {
	...
	public String getFileName() throws IOException {
		...
		String fileName = System.getProperty("user.dir")+"/FileShare/Common.cfg";
		BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(fileName)));
		String line="";
		String []tokens = new String[4];
		int count=0;
	...
	public void ReadCommonConfigFile () throws IOException {
		String FileName = System.getProperty("user.dir")+"/FileShare/Common.cfg";BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(FileName)));
		String line=null;
		int lineCount=0;
		String []temp = new String[2];
	...
	public void SplitFile (String FileName, long FileSize, int PieceSize, int PeerID) throws IOException {
		...
		FileName = System.getProperty("user.dir")+"/FileShare/peer_"+PeerID+"/"+FileName;
	...
	public ArrayList<Integer> readPiece (int pieceIndex, int PeerID) throws IOException {
		...
		int bytesRead=0;
		String FileName = System.getProperty("user.dir")+"/FileShare/peer_"+PeerID+"/"+this.getFileName();
	...
	public static void main (String []args) throws IOException {
		...
		String FileName = System.getProperty("user.dir")+"/src/FileShare/1.mp3";
